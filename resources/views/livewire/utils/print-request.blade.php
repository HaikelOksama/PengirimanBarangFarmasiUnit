        ...
        <div class="text-start text-sm">
            <div class="flex">
                ...
                <div class="flex flex-col">
                    <h1 class="font-bold uppercase" style="font-size: 15px;"> <i>{{ $matreq->fromUnit->nama }}</i></h1>
                    <p class="text-xs font-extralight">{{ $matreq->fromUnit->alamat }}</p>

                    <h2 class="text-sm my-2 py-5 px-0 nowrap">PERMINTAAN BARANG FARMALKES KE UNIT</h2>
                </div>
            </div>
